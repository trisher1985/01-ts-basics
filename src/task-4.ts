...
// Додано анотації типів для параметрів: name як string, age як number, email як опціональний string (через ?)
// Вказано тип повернення void, оскільки функція нічого не повертає
