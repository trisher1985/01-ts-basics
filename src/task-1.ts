...
const name: string = "Alice"; //тип string для змінної name
const age: number = 30;  //тип number для змінної age
const isOnline: boolean = true;  //тип boolean для змінної isOnline
